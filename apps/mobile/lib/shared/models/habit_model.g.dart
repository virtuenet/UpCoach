...
_Habit _$HabitFromJson(Map<String, dynamic> json) => _Habit(
  ...
  type:
      $enumDecodeNullable(_$HabitTypeEnumMap, json['type']) ?? HabitType.simple,
  frequency:
...
_HabitStreak _$HabitStreakFromJson(Map<String, dynamic> json) => _HabitStreak(
  id: json['id'] as String,
  habitId: json['habitId'] as String,
...
Map<String, dynamic> _$HabitStreakToJson(_HabitStreak instance) =>
    <String, dynamic>{
      'id': instance.id,
      'habitId': instance.habitId,
      'startDate': instance.startDate.toIso8601String(),
...
_HabitAchievement _$HabitAchievementFromJson(Map<String, dynamic> json) =>
    _HabitAchievement(
      id: json['id'] as String,
      habitId: json['habitId'] as String,
...
Map<String, dynamic> _$HabitAchievementToJson(_HabitAchievement instance) =>
    <String, dynamic>{
      'id': instance.id,
      'habitId': instance.habitId,
      'type': instance.type,
