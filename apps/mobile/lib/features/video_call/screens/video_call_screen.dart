...
class _VideoCallScreenState extends ConsumerState<VideoCallScreen>
  ...
  void initState() {
    ...
    // Set immersive mode for video call
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    if (state == AppLifecycleState.paused) {
      // App going to background - could minimize video
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Center(
              child: Text(
                widget.coachName?.substring(0, 2).toUpperCase() ?? 'UC',
      ...
      child: Center(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            Text(
              'Please wait while we set up your ${widget.callType == CallType.video ? 'video' : 'audio'} call',
              style: TextStyle(
                fontSize: 14,
                color: Colors.white.withValues(alpha: 0.7),
              ),
