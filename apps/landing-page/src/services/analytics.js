...
export const trackLeadCapture = (trigger) => {
...
export const trackDemoInteraction = (feature, action) => {
...
export const trackPlanSelect = (plan, billing) => {
...
export const trackEcommerceEvent = (eventName, parameters) => {
    if (!isGALoaded())
        return;
...
// Custom dimensions
export const setCustomDimension = (name, value) => {
    if (!isGALoaded())
        return;
...
// Track modal view
export const trackModalView = (modalName, trigger) => {
    event('modal_view', {
        event_category: 'engagement',
