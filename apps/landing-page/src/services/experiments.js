...
function matchesTargetAudience(experiment) {
    ...
    if (newUsers !== undefined || returningUsers !== undefined) {
        ...
        if (newUsers && !isNewUser)
            return false;
        if (returningUsers && isNewUser)
            return false;
    }
    // Check device type
...
export function trackExperimentView(experimentId, variantId) {
...
export function trackExperimentConversion(experimentId, conversionType, value) {
