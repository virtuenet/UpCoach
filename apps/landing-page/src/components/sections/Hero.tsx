...
const HERO_FALLBACK: Required<HeroContent> = {
  badge: 'AI-Powered Personal Development',
  headline: 'Unlock Your Full Potential with',
  highlight: 'AI-Driven Coaching',
  description:
  ...
  demoLabel: 'Watch 2-minute Demo',
  trustIndicators: ['No credit card required', 'Free 7-day trial', 'Cancel anytime'],
};
...
export default function Hero({ content }: HeroProps) {
  const copy = {
    ...HERO_FALLBACK,
    ...(content ?? {}),
    trustIndicators: content?.trustIndicators?.length
      ? content.trustIndicators
      : HERO_FALLBACK.trustIndicators,
  };
