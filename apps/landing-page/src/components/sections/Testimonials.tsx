...
export default function Testimonials({ testimonials }: TestimonialsProps) {
  const testimonialData = testimonials?.length ? testimonials : FALLBACK_TESTIMONIALS;
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 relative">
            ...
            <div className="relative z-10">
              ...
              <div className="flex items-center">
                <div
                  className={`w-16 h-16 rounded-full ${testimonialData[activeIndex].avatarBg ?? 'bg-primary-500'} flex items-center justify-center text-white font-bold text-xl mr-4`}
                >
                  {testimonialData[activeIndex].avatar}
                </div>
                <div>
                  ...
                  <p className="text-gray-600">
                    ...
                    {testimonialData[activeIndex].company ? ` at ${testimonialData[activeIndex].company}` : ''}
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {testimonialData.slice(0, 3).map((testimonial, index) => (
            ...
            >
              ...
              <div className="flex items-center">
                <div
                  className={`w-10 h-10 rounded-full ${testimonial.avatarBg} flex items-center justify-center text-white font-semibold text-sm mr-3`}
                >
                  {testimonial.avatar}
                </div>
                <div>
