...
const CTA_FALLBACK: Required<CtaContent> = {
  badge: 'Rated 4.9/5 by 50,000+ users',
  headline: 'Start Your Transformation',
  highlight: 'Today',
  description:
    'Join thousands of professionals achieving their goals with AI-powered coaching. Download UpCoach now and get 7 days free.',
  metrics: [
    { label: 'Downloads', value: '500K+' },
    { label: 'Rating', value: '4.9/5' },
    { label: 'Productivity App', value: '#1' },
...
export default function CTA({ content }: CTAProps) {
  const copy = {
    ...CTA_FALLBACK,
    ...(content ?? {}),
    metrics: content?.metrics?.length ? content.metrics : CTA_FALLBACK.metrics,
  };
  return (
    <section
      id="download"
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full mb-8">
            ...
            <span className="text-white font-medium">{copy.badge}</span>
          </div>
