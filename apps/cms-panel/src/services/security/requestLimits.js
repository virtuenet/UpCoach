...
class RequestLimitsService {
     ...
     * Check JSON depth
     */
    checkJsonDepth(obj, maxDepth = this.config.maxJsonDepth) {
     ...
     */
    checkArrayLength(obj, maxLength = this.config.maxArrayLength) {
        if (obj === null || typeof obj !== 'object') {
            return true;
        }
        const stack = [obj];
...
export const requestLimitsMiddleware = (options) => requestLimits.middleware(options);
export const uploadLimitsMiddleware = () => requestLimits.uploadMiddleware();
//# sourceMappingURL=requestLimits.js.map