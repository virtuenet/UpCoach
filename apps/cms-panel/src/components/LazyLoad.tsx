...
export const LazyPages = {
  ...
  // Landing & Remote Copy
  LandingExperience: lazyLoad(() => import('../pages/LandingExperiencePage')),
  ...
  CoachMarketplace: lazyLoad(() => import('../pages/MarketplaceModerationPage')),
...
export const lazyRoutes = [
  ...
  {
    path: '/experience/landing',
    component: LazyPages.LandingExperience,
  },
  {
