...
export const metadata: Metadata = {
  title: 'Contact Us',
  description: 'Get in touch with the UpCoach team. We\'re here to help you transform your professional development journey.',
  openGraph: {
    title: 'Contact UpCoach - Get in Touch',
    description: 'Have questions about UpCoach? We\'d love to hear from you. Contact our team for support, partnerships, or general inquiries.',
  },
};
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="text-center max-w-3xl mx-auto">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
              Get in Touch with
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-secondary-600"> UpCoach</span>
            </h1>
            <p className="text-xl text-gray-600">
              Have questions? Need help? We're here for you. Reach out and let's start a conversation.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl p-6">
              ...
              <p className="text-gray-600">
                For the fastest response, use our live chat feature available in the app and on our website. 
                For complex issues, email support@upcoach.ai with detailed information.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6">
              ...
              <p className="text-gray-600">
                Yes! We offer custom enterprise solutions for teams of 50+ users. 
                Contact our enterprise team at enterprise@upcoach.ai to discuss your needs.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6">
              ...
              <p className="text-gray-600">
                Absolutely! Fill out the contact form above and select "Product Demo" as your inquiry type. 
            ...
            <div className="bg-white rounded-xl p-6">
              ...
              <p className="text-gray-600">
                ...
                Check out our careers page at upcoach.ai/careers or email jobs@upcoach.ai.
              </p>
            </div>
          </div>
        </div>
