        ...
        <div className="container mx-auto max-w-7xl">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl text-gray-600">
              Have questions? Need help? We're here for you. Reach out and let's
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl p-6">
              ...
              <p className="text-gray-600">
                For the fastest response, use our live chat feature available in
                the app and on our website. For complex issues, email
                support@upcoach.ai with detailed information.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6">
              ...
              <p className="text-gray-600">
                Yes! We offer custom enterprise solutions for teams of 50+
                users. Contact our enterprise team at enterprise@upcoach.ai to
                discuss your needs.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6">
              ...
              <p className="text-gray-600">
                Absolutely! Fill out the contact form above and select "Product
                Demo" as your inquiry type. Our team will reach out within 24
            ...
            <div className="bg-white rounded-xl p-6">
              ...
              <p className="text-gray-600">
                ...
                Check out our careers page at upcoach.ai/careers or email
                jobs@upcoach.ai.
              </p>
            </div>
          </div>
