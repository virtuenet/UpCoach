...
const coachingStyles = [
  { value: 'supportive', label: 'Supportive & Encouraging', description: 'Gentle guidance with positive reinforcement' },
  { value: 'challenging', label: 'Direct & Challenging', description: 'Push boundaries and challenge comfort zones' },
  { value: 'analytical', label: 'Analytical & Strategic', description: 'Data-driven approach with clear strategies' },
  { value: 'holistic', label: 'Holistic & Balanced', description: 'Consider all aspects of life and well-being' },
];
...
export default function OnboardingPage() {
  ...
  const [data, setData] = useState<OnboardingData>({
    ...
    preferences: { coachingStyle: '', sessionFrequency: '', focusAreas: [], challenges: '' },
    availability: { preferredDays: [], preferredTimes: [], commitmentLevel: '' },
  });
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <RadioGroup
                        ...
                        onValueChange={(value) => updateData('availability', 'commitmentLevel', value)}
                        className="mt-2"
                      >
