...
const AppDownload = dynamic(() => import('@/components/sections/AppDownload'), {
  loading: () => <div className="h-96 bg-gradient-to-r from-primary-600 to-secondary-600 animate-pulse" />,
});

const CTA = dynamic(() => import('@/components/sections/CTA'), {
  loading: () => <div className="h-64 bg-gradient-to-r from-primary-600 to-secondary-600 animate-pulse" />,
});
