        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div>
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-secondary-600"> Amazing Together</span>
            </h2>
            <p className="text-lg text-gray-600 mb-8">
              Whether you have a question, feedback, or want to explore partnership opportunities, we're here to help.
            </p>
