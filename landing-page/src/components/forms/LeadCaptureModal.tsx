                    ...
                    <Variant variant="control">
                      <div className="text-center mb-8">
                        ...
                        <p className="text-lg text-gray-600 max-w-md mx-auto">
                          Join 25,000+ professionals and get our exclusive
                          guide: "10 Science-Backed Habits for Peak Performance"
                        </p>
                      </div>
                    </Variant>
                    <Variant variant="variant-a">
                      <div className="text-center mb-8">
                        ...
                        <p className="text-lg text-gray-600 max-w-md mx-auto">
                          The same template used by 25,000+ high performers to
                          build life-changing habits in 30 days
                        </p>
                      </div>
                    </Variant>
                    <Variant variant="variant-b">
                      <div className="text-center mb-8">
                        ...
                        <p className="text-lg text-gray-600 max-w-md mx-auto">
                          Discover how AI can 10x your personal growth with our
