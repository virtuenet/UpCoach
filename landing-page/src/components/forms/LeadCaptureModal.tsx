                    ...
                    <Variant variant="control">
                      <div className="text-center mb-8">
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                          Get Your Free 
                          <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-secondary-600"> Productivity Guide</span>
                        </h2>
                        <p className="text-lg text-gray-600 max-w-md mx-auto">
                          Join 25,000+ professionals and get our exclusive guide: 
                          "10 Science-Backed Habits for Peak Performance"
                        </p>
                      </div>
                    </Variant>
                    <Variant variant="variant-a">
                      <div className="text-center mb-8">
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                          Download Your Free
                          <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-secondary-600"> Habit Tracker</span>
                        </h2>
                        <p className="text-lg text-gray-600 max-w-md mx-auto">
                          The same template used by 25,000+ high performers 
                          to build life-changing habits in 30 days
                        </p>
                      </div>
                    </Variant>
                    <Variant variant="variant-b">
                      <div className="text-center mb-8">
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                          Unlock AI Coaching
                          <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-secondary-600"> Secrets</span>
                        </h2>
                        <p className="text-lg text-gray-600 max-w-md mx-auto">
                          Discover how AI can 10x your personal growth 
                          with our exclusive insider guide
                        </p>
                      </div>
                    </Variant>
                  </ABTestSwitch>
