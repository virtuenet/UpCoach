...
export default function CTA() {
  return (
    <section id="download" className="py-24 bg-gradient-to-br from-primary-600 via-secondary-600 to-primary-700 relative overflow-hidden">
      {/* Background pattern */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-white/90 mb-12 max-w-3xl mx-auto leading-relaxed">
            Join thousands of professionals achieving their goals with AI-powered coaching. 
            Download UpCoach now and get 7 days free.
          </p>
