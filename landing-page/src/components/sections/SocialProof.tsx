...
const successStories = [
  ...
  },
  {
    ...
    beforeAfter: { before: 'Daily anxiety', after: '90% reduction', duration: '6 months' },
  ...
  return (
    <section className="py-24 bg-gradient-to-b from-white to-gray-50 overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        >
          <span className="text-primary-600 font-semibold text-sm uppercase tracking-wider">Social Proof</span>
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4 mt-2">
            Trusted by Thousands
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-secondary-600"> Worldwide</span>
          </h2>
        ...
        <motion.div 
          ...
          className="mb-20"
        >
          <h3 className="text-2xl font-bold text-center text-gray-900 mb-8">Awards & Recognition</h3>
            ...
            {awards.map((award, index) => (
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600">{award.provider} • {award.date}</div>
                </div>
              </motion.div>
            ))}
          </div>
                  ...
                  <div className="bg-gray-50 rounded-xl p-4">
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <div>
                        ...
                        <div className="font-semibold text-primary-600">{story.beforeAfter.after}</div>
                      </div>
                    </div>
