          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-600 mb-8">
                Join thousands of professionals who are transforming their lives with UpCoach. Sign
                up now to secure your lifetime discount and exclusive benefits.
              </p>
            ...
            >
              <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
                ...
                <div className="bg-red-50 border border-red-200 rounded-xl p-4 mb-6 text-center">
                  <p className="text-red-600 font-semibold">🔥 Early bird offer ends in 48 hours</p>
                </div>

                <h3 className="text-2xl font-bold text-gray-900 mb-2">Reserve Your Spot</h3>
                <p className="text-gray-600 mb-6">No credit card required. Unsubscribe anytime.</p>
