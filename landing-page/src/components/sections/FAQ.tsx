      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4 mt-2">
            Got Questions?
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-secondary-600"> We've Got Answers</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Everything you need to know about UpCoach and how it can transform your personal development journey.
          </p>
        </motion.div>
                    ...
                    >
                      ...
                      <ChevronDown 
                        className={`w-5 h-5 text-gray-500 transition-transform duration-300 ${
                          openIndex === `${openCategory}-${index}` ? 'rotate-180' : ''
                        }`}
                      />
                    </button>
