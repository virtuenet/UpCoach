export default function StructuredData() {
  const organizationSchema = {
    ...
    name: "UpCoach",
    description:
      "AI-powered personal coaching platform for professional development",
  ...
  const mobileAppSchema = {
    ...
    description:
      "Transform your life with AI-powered coaching. Voice journaling, habit tracking, and personalized insights.",
    screenshot: [
