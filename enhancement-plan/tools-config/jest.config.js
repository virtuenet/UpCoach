module.exports = {
  ...
  projects: [
    ...
    // Financial services tests
    {
      ...
      setupFilesAfterEnv: [
        '<rootDir>/testing/setup/financial.setup.js'
      ],
    ...
    // Database integration tests
    {
      ...
      testEnvironment: 'node',
      testMatch: [
        '<rootDir>/testing/integration/database/**/*.test.{js,ts}'
      ],
      setupFilesAfterEnv: [
        '<rootDir>/testing/setup/database-integration.setup.js'
      ],
    ...
    // Voice journaling tests
    {
      ...
      setupFilesAfterEnv: [
        '<rootDir>/testing/setup/voice-journaling.setup.js'
      ]
    },
    ...
    // Habit tracking tests
    {
      ...
      setupFilesAfterEnv: [
        '<rootDir>/testing/setup/habit-tracking.setup.js'
      ]
    },
    ...
    // Offline sync tests
    {
      ...
      setupFilesAfterEnv: [
        '<rootDir>/testing/setup/offline-sync.setup.js'
      ]
    }
  ],
  ...
  reporters: [
    ...
    [
      '@jest/test-result-processor',
      '<rootDir>/testing/processors/slack-reporter.js'
    ]
  ],
