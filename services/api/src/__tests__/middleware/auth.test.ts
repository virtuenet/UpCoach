...
import { createMockRequest, createMockResponse } from '../helpers/test-app';
...
describe('Auth Middleware', () => {
  describe('generateTokens', () => {
    test('should generate valid access and refresh tokens', () => {
      ...
      const accessPayload = jwt.verify(tokens.accessToken, 'test-jwt-secret') as any;
      ...
      const refreshPayload = jwt.verify(tokens.refreshToken, 'test-refresh-secret') as any;
  ...
  describe('Token Security', () => {
    ...
    test('should include unique jti in tokens', () => {
      ...
      const payload1 = jwt.verify(tokens1.accessToken, 'test-jwt-secret') as any;
      const payload2 = jwt.verify(tokens2.accessToken, 'test-jwt-secret') as any;
