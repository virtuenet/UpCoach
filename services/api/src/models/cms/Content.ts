...
export type UserModel = ModelStatic<unknown>;
export type ContentCategoryModel = ModelStatic<unknown>;
export type ContentMediaModel = ModelStatic<unknown>;
export type ContentTagModel = ModelStatic<unknown>;
