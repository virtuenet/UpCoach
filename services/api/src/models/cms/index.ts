...
export function initializeCMSModels(sequelize: Sequelize): void {
  ...
  LandingSection.initializeModel(sequelize);
  LandingCtaBlock.initializeModel(sequelize);
  LandingPricingTier.initializeModel(sequelize);
  LandingTestimonialCard.initializeModel(sequelize);
  LandingBlogCard.initializeModel(sequelize);
  LandingComparisonTable.initializeModel(sequelize);
  RemoteCopyEntry.initializeModel(sequelize);
