...
export class AIMockPatterns {
  static generateCoachingResponse(input: string, context: any = {}): AIResponse {
    const responses = {
...
export class MockDatabaseUtils {
  static mockSequelizeModel(model: any) {
    return {
      findAll: jest.fn(),
      findOne: jest.fn(),
      findByPk: jest.fn(),
...
export class AIResponseValidators {
  ...
  static validateRecommendations(recommendations: any): void {
  ...
  static validateUserProfile(profile: any): void {
  ...
  static validateInsightReport(report: any): void {
  ...
  static validateSchedule(schedule: any): void {
