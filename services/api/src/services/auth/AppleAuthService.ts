...
export class AppleAuthService {
  ...
  private async validateAccountLinking(existingUser: any, appleUser: AppleUserInfo): Promise<void> {
  ...
  private async findUserByAppleId(appleId: string): Promise<any> {
    try {
  ...
  private async createAppleUser(appleUser: AppleUserInfo, request: AppleAuthRequest): Promise<any> {
    try {
  ...
  private async syncWithSupabase(user: any, appleUser: AppleUserInfo): Promise<void> {
