...
export class FacebookAuthService {
  ...
  async signIn(request: FacebookAuthRequest): Promise<FacebookSignInResponse> {
    ...
    const securityEvents: Array<{ type: string; timestamp: string; details: any }> = [];
  ...
  private async validateAccountLinking(existingUser: any, facebookUser: FacebookUserInfo): Promise<void> {
  ...
  private async findUserByFacebookId(facebookId: string): Promise<any> {
    try {
  ...
  private async createFacebookUser(facebookUser: FacebookUserInfo, request: FacebookAuthRequest): Promise<any> {
    try {
  ...
  private async syncWithSupabase(user: any, facebookUser: FacebookUserInfo): Promise<void> {
