...
export class LinkedInAdsClient {
   ...
   */
  public async getRealTimeMetrics(campaignId: string): Promise<any> {
   ...
   */
  public async getAudienceInsights(targeting: LinkedInTargeting): Promise<any> {
   ...
   */
  private transformCampaignData(data: any): LinkedInCampaign {
    return {
      id: data.id,
      name: data.name,
