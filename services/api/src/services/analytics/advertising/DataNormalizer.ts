...
export class DataNormalizer {
   ...
   */
  public normalizeGoogleAdsData(data: any[]): NormalizedCampaign[] {
   ...
   */
  public normalizeMetaAdsData(data: any[]): NormalizedCampaign[] {
    const normalized: NormalizedCampaign[] = [];
    ...
    for (const campaign of data) {
      try {
        ...
        const normalizedCampaign: NormalizedCampaign = {
          ...
          cpa: campaign.cost_per_action_type?.find((a: any) => a.action_type === 'purchase')?.value || 0,
   ...
   */
  public normalizeLinkedInAdsData(data: any[]): NormalizedCampaign[] {
    const normalized: NormalizedCampaign[] = [];
   ...
   */
  public normalizeGoogleAdsWebhook(data: any): any {
    return {
   ...
   */
  public normalizeMetaAdsWebhook(data: any): any {
    return {
      type: data.field,
      platform: 'meta_ads',
      ...
      metrics: {
        ...
        conversions: data.value?.actions?.find((a: any) =>
   ...
   */
  public normalizeLinkedInAdsWebhook(data: any): any {
    return {
      type: 'campaign_update',
   ...
   */
  private normalizeGoogleMetrics(data: any, base: NormalizedMetrics): NormalizedMetrics {
    return {
      ...base,
   ...
   */
  private normalizeMetaMetrics(data: any, base: NormalizedMetrics): NormalizedMetrics {
    return {
      ...base,
      campaignId: data.campaign_id,
   ...
   */
  private normalizeLinkedInMetrics(data: any, base: NormalizedMetrics): NormalizedMetrics {
    return {
      ...base,
      campaignId: data.campaign_id,
      impressions: data.impressions || 0,
