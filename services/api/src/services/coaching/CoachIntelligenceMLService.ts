...
interface MLModelConfig {
  ...
  inputShape: number[];
  outputShape: number[];
  preprocessing?: (input: any) => tf.Tensor;
...
export class CoachIntelligenceMLService extends EventEmitter {
   ...
   */
  private calculateNPSFactors(features: number[]): any {
    return {
   ...
   */
  private generateNPSRecommendations(score: number, factors: any): string[] {
