...
export class QueryOptimizer {
  ...
  private setupQueryLogging() {
    ...
    if (process.env.NODE_ENV === 'development') {
      (this.sequelize as any).options.benchmark = true;
    }
  }
  ...
  async analyzeQuery(sql: string, replacements?: any): Promise<QueryPlan[]> {
    try {
  ...
  private parseExplainOutput(output: any[]): QueryPlan[] {
