...
const advancedAnalytics_1 = tslib_1.__importDefault(require("./advancedAnalytics"));
const ai_1 = tslib_1.__importDefault(require("./ai"));
const financial_1 = tslib_1.__importDefault(require("./financial"));
const coachContent_1 = tslib_1.__importDefault(require("./coachContent"));
const referral_1 = tslib_1.__importDefault(require("./referral"));
const onboarding_1 = tslib_1.__importDefault(require("./onboarding"));
const forum_1 = tslib_1.__importDefault(require("./forum"));
const aiAnalytics_1 = tslib_1.__importDefault(require("./aiAnalytics"));
const performance_1 = tslib_1.__importDefault(require("./analytics/performance"));
const auth_2 = tslib_1.__importDefault(require("./auth"));
const googleAuth_1 = tslib_1.__importDefault(require("./googleAuth"));
const chat_1 = tslib_1.__importDefault(require("./chat"));
const cms_1 = tslib_1.__importDefault(require("./cms"));
const coach_1 = tslib_1.__importDefault(require("./coach"));
const csrf_1 = tslib_1.__importDefault(require("./csrf"));
const enterprise_1 = tslib_1.__importDefault(require("./enterprise"));
const gamification_1 = tslib_1.__importDefault(require("./gamification"));
const goals_1 = tslib_1.__importDefault(require("./goals"));
const mood_1 = tslib_1.__importDefault(require("./mood"));
const tasks_1 = tslib_1.__importDefault(require("./tasks"));
const twoFactorAuth_1 = tslib_1.__importDefault(require("./twoFactorAuth"));
const users_1 = tslib_1.__importDefault(require("./users"));
const voiceJournal_1 = tslib_1.__importDefault(require("./voiceJournal"));
const localLLM_1 = require("./localLLM");
const v2_1 = tslib_1.__importDefault(require("./v2"));
...
const setupRoutes = (app) => {
    ...
    app.use(`${apiPrefix}/analytics`, performance_1.default);
