...
const UnifiedEmailService_1 = tslib_1.__importDefault(require("../../services/email/UnifiedEmailService"));
...
class FinancialDashboardController {
    ...
    async generateCostOptimizationSuggestions() {
        const suggestions = [];
        try {
            const { CostTracking } = await Promise.resolve().then(() => tslib_1.__importStar(require('../../models/financial/CostTracking')));
