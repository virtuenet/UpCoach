...
export declare class MediaController {
    ...
    static processUpload(req: Request, _res: Response): Promise<Response<any, Record<string, any>> | undefined>;
    static processMultipleUploads(req: Request, _res: Response): Promise<Response<any, Record<string, any>> | undefined>;
