...
const ContentComment_1 = tslib_1.__importDefault(require("../../models/cms/ContentComment"));
const ContentInteraction_1 = tslib_1.__importDefault(require("../../models/cms/ContentInteraction"));
...
const ContentTemplate_1 = tslib_1.__importDefault(require("../../models/cms/ContentTemplate"));
...
const UploadService_1 = tslib_1.__importDefault(require("../../services/upload/UploadService"));
        ...
        const analytics = {
            ...
            categoryBreakdown: await ContentCategory_1.ContentCategory.findAll({
                attributes: [
                    'id',
                    'name',
                    [sequelize_1.default.fn('COUNT', sequelize_1.default.col('articles.id')), 'articleCount'],
                ],
                include: [
                    {
...
const getArticleAnalytics = async (req, _res) => {
    try {
        ...
        const interactions = await ContentInteraction_1.default.findAll({
            where: { contentId: id },
            attributes: ['interactionType', [sequelize_1.default.fn('COUNT', sequelize_1.default.col('id')), 'count']],
