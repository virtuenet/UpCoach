...
exports.AITestDataFactory = AITestDataFactory;
class AIMockPatterns {
    static generateCoachingResponse(input, context = {}) {
        const responses = {
        ...
        const content = responses[responseType] || responses.default;
        return AITestDataFactory.createMockAIResponse(content);
    }
    static generateRecommendations(userId, type = 'goals') {
    ...
    static generateSchedule(userId, date) {
        return {
            morning: [
    ...
    static generateOptimalTiming(userId, activity) {
        const timingData = {
            exercise: {
                bestTime: 'morning',
        ...
        return timingData[activity] || timingData.exercise;
    }
...
exports.AIMockPatterns = AIMockPatterns;
class PerformanceTestUtils {
    ...
    static async measureConcurrentRequests(fn, concurrency) {
        const startTime = Date.now();
    ...
    static validateResponseTime(duration, threshold) {
        expect(duration).toBeLessThan(threshold);
    }
    static validateConcurrencyPerformance(avgDuration, threshold) {
        expect(avgDuration).toBeLessThan(threshold);
    }
}
exports.PerformanceTestUtils = PerformanceTestUtils;
class MockDatabaseUtils {
    static mockSequelizeModel(model) {
        return {
            findAll: jest.fn(),
            findOne: jest.fn(),
            findByPk: jest.fn(),
...
exports.MockDatabaseUtils = MockDatabaseUtils;
class AIResponseValidators {
    ...
    static validateInsightReport(report) {
...
exports.AIResponseValidators = AIResponseValidators;
