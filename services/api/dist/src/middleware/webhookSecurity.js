...
function verifyWebhookSignature(config) {
    return async (req, _res, next) => {
        const { secret, algorithm = 'sha256', headerName = 'x-webhook-signature', maxAge = 300, replayProtection = true, } = config;
        try {
...
async function deduplicateWebhook(eventId, ttl = 86400) {
