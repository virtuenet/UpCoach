    ...
    async generateType2Report(startDate, endDate) {
        try {
            const report = {
                ...
                trustServiceCriteria: {
                    CC1: await this.getCommonCriteria('CC1', startDate, endDate),
                    CC2: await this.getCommonCriteria('CC2', startDate, endDate),
                    CC3: await this.getCommonCriteria('CC3', startDate, endDate),
                    CC4: await this.getCommonCriteria('CC4', startDate, endDate),
                    CC5: await this.getCommonCriteria('CC5', startDate, endDate),
                    CC6: await this.getCommonCriteria('CC6', startDate, endDate),
                    CC7: await this.getCommonCriteria('CC7', startDate, endDate),
                    CC8: await this.getCommonCriteria('CC8', startDate, endDate),
                    CC9: await this.getCommonCriteria('CC9', startDate, endDate),
                },
