...
const envSchema = zod_1.z.object({
    ...
    BCRYPT_ROUNDS: zod_1.z.string().default('14'),
    ...
    SMS_SIMULATE_FAILURE: zod_1.z.string().optional().default('false'),
    ...
    SENTRY_TRACES_SAMPLE_RATE: zod_1.z.string().optional().default('0.1'),
    SENTRY_PROFILES_SAMPLE_RATE: zod_1.z.string().optional().default('0.1'),
    DATADOG_ENABLED: zod_1.z
        .string()
        .optional()
        .default('false'),
    DATADOG_AGENT_HOST: zod_1.z.string().optional().default('localhost'),
    DATADOG_AGENT_PORT: zod_1.z.string().optional(),
    DATADOG_STATSD_HOST: zod_1.z.string().optional().default('localhost'),
    DATADOG_STATSD_PORT: zod_1.z.string().optional(),
