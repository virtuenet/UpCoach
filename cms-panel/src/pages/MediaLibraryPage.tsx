  ...
  const {
    ...
    queryFn: () =>
      mediaApi.getMedia({
        ...
        folder:
          folderFilter === 'all' ? undefined : folderFilter === 'none' ? undefined : folderFilter,
        page: currentPage,
        limit: 20,
        sortBy: 'createdAt',
        sortOrder: 'DESC',
    ...
    <div className="space-y-6" {...getRootProps()}>
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">Manage your files and media assets</p>
        </div>
        ...
        {mediaData?.pagination && mediaData.pagination.totalPages > 1 && (
          <div className="bg-white px-4 py-3 flex items-center justify-between border-t border-gray-200 sm:px-6">
            <div className="flex-1 flex justify-between sm:hidden">
              ...
              <button
                onClick={() =>
                  setCurrentPage(Math.min(mediaData.pagination.totalPages, currentPage + 1))
                }
            ...
            <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
              <div>
                <p className="text-sm text-gray-700">
                  ...
                  <span className="font-medium">
                    {Math.min(
                      currentPage * mediaData.pagination.itemsPerPage,
                      mediaData.pagination.totalItems
                    )}
                  </span>{' '}
  ...
  return (
    <div className="relative group bg-gray-50 rounded-lg overflow-hidden hover:bg-gray-100 transition-colors">
      ...
      <div className="p-3">
        ...
        <p className="text-xs text-gray-500">{mediaApi.formatFileSize(item.fileSize)}</p>
        {item.folder && <p className="text-xs text-blue-600">📁 {item.folder}</p>}
      </div>
      ...
      <div className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity">
        <div className="flex gap-1">
          <button onClick={onEdit} className="p-1 bg-white rounded shadow hover:bg-gray-50">
...
const MediaListItem = ({
  ...
  return (
    <tr className="hover:bg-gray-50">
      ...
      <td className="px-6 py-4 whitespace-nowrap">
        <div className="flex items-center">
          ...
          <div className="ml-4">
            ...
            {item.alt && <div className="text-sm text-gray-500">{item.alt}</div>}
          </div>
        </div>
      </td>
      <td className="px-6 py-4 whitespace-nowrap">
      ...
      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{item.folder || '—'}</td>
      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
