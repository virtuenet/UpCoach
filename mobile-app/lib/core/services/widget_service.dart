...
class WidgetService {
  ...
  Future<void> updateGoalsWidget({
    ...
    try {
      ...
      print('Error updating goals widget: $e');
    }
  }
  ...
  Future<void> updateTasksWidget({
    ...
    try {
      ...
      print('Error updating tasks widget: $e');
    }
  }
  ...
  Future<void> updateStreakWidget({
    ...
    try {
      ...
      await HomeWidget.saveWidgetData<String>('last_activity', lastActivityDate);
      await HomeWidget.saveWidgetData<String>('last_updated', DateTime.now().toIso8601String());
      
      // Update the widget
      await _updateWidget();
    } catch (e) {
      print('Error updating streak widget: $e');
    }
  }
  ...
  Future<void> updateProgressWidget({
    ...
    try {
      ...
      await HomeWidget.saveWidgetData<double>('weekly_progress', weeklyProgress);
      await HomeWidget.saveWidgetData<int>('sessions_completed', sessionsCompleted);
      ...
      print('Error updating progress widget: $e');
    }
  }
...
final widgetConfigProvider = StateNotifierProvider<WidgetNotifier, String>((ref) {
  final service = ref.watch(widgetServiceProvider);
