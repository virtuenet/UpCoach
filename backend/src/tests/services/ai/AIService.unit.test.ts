...
describe('AI Service Unit Tests', () => {
  ...
  describe('Response Generation', () => {
    ...
    it('should handle empty messages array', async () => {
      ...
      await expect(aiService.generateResponse(messages)).resolves.toBeDefined();
    });
  ...
  describe('Error Handling', () => {
    it('should handle API errors gracefully', async () => {
      ...
      jest.spyOn(aiService as any, 'generateOpenAIResponse').mockRejectedValueOnce(mockError);
  ...
  describe('Coaching Response', () => {
    it('should generate coaching response without history', async () => {
      ...
      const response = await aiService.generateCoachingResponse('How can I improve?');
    ...
    it('should include conversation history', async () => {
      ...
      const response = await aiService.generateCoachingResponse('Follow up question', {
        conversationHistory: history,
      });

      expect(response).toBeDefined();
      expect(aiService.generateResponse).toHaveBeenCalledWith(
        expect.arrayContaining([...history, { role: 'user', content: 'Follow up question' }]),
        expect.any(Object)
      );
    });
  });
