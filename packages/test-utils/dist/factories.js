...
// Coach factory
export const createCoach = (overrides = {}) => createUser({
    role: 'coach',
    profile: {
...
// Batch creators
export const createUsers = (count = 10, overrides = {}) => Array.from({ length: count }, () => createUser(overrides));
export const createContents = (count = 10, overrides = {}) => Array.from({ length: count }, () => createContent(overrides));
export const createGoals = (count = 5, overrides = {}) => Array.from({ length: count }, () => createGoal(overrides));
export const createTasks = (count = 10, overrides = {}) => Array.from({ length: count }, () => createTask(overrides));
