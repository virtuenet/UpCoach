...
export const Navigation = ({
            ...
            _jsx(ListItem, {
              ...
              children: _jsxs(ListItemButton, {
                ...
                children: [
                  ...
                  _jsx(ListItemText, { primary: item.label }),
                  hasChildren && (isExpanded ? _jsx(ExpandLess, {}) : _jsx(ExpandMore, {})),
                ],
              }),
            }),
            hasChildren &&
              _jsx(Collapse, {
                ...
                children: _jsx(List, {
                  component: 'div',
                  disablePadding: true,
                  children: renderNavItems(item.children, depth + 1),
                }),
              }),
          ],
        },
  ...
  const drawerContent = _jsxs(_Fragment, {
    children: [
      _jsxs(DrawerHeader, {
        children: [
          _jsxs(Box, {
            ...
            children: [
              logo,
              variant !== 'mini' &&
                _jsx(Typography, { variant: 'h6', noWrap: true, children: title }),
            ],
          }),
          variant !== 'temporary' &&
            _jsx(IconButton, {
              ...
              children:
                theme.direction === 'ltr' ? _jsx(ChevronLeftIcon, {}) : _jsx(ChevronRightIcon, {}),
            }),
        ],
      }),
      _jsx(Divider, {}),
      _jsx(List, { children: renderNavItems(items) }),
    ],
  });
  const appBarContent = _jsx(AppBar, {
    position: 'fixed',
    open: position === 'left' && open,
              ...
              _jsxs(Menu, {
                ...
                children: [
                  _jsxs(Box, {
                    sx: { px: 2, py: 1 },
                    children: [
                      _jsx(Typography, { variant: 'subtitle1', children: user.name }),
                      user.email &&
                        _jsx(Typography, {
                          variant: 'body2',
