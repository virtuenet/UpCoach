...
export declare const responsiveValue: <T>(values: Partial<Record<"md" | "xs" | "sm" | "lg" | "xl", T>>, currentBreakpoint: keyof typeof breakpoints) => T | undefined;
declare const _default: {
    ...
    media: {
        readonly up: (breakpoint: "md" | "xs" | "sm" | "lg" | "xl") => string;
        readonly down: (breakpoint: "md" | "xs" | "sm" | "lg" | "xl") => string;
        readonly between: (min: "md" | "xs" | "sm" | "lg" | "xl", max: "md" | "xs" | "sm" | "lg" | "xl") => string;
        readonly only: (breakpoint: "md" | "xs" | "sm" | "lg" | "xl") => string;
        readonly device: {
            readonly mobile: "@media (max-width: 599px)";
            readonly tablet: "@media (min-width: 600px) and (max-width: 959px)";
            readonly desktop: "@media (min-width: 960px)";
    ...
    isBreakpoint: (breakpoint: "md" | "xs" | "sm" | "lg" | "xl", width: number) => boolean;
    getCurrentBreakpoint: (width: number) => "md" | "xs" | "sm" | "lg" | "xl";
    responsiveValue: <T>(values: Partial<Record<"md" | "xs" | "sm" | "lg" | "xl", T>>, currentBreakpoint: "md" | "xs" | "sm" | "lg" | "xl") => T | undefined;
};
