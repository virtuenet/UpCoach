...
export class ARIAUtils {
     ...
     */
    static generateId(prefix = 'upcoach') {
     ...
     */
    static createErrorMessage(fieldId, message) {
...
export class FormAccessibility {
     ...
     */
    static addRequiredIndicator(input) {
     ...
     */
    static addValidationSupport(input) {
        const htmlInput = input;
        const validateField = () => {
