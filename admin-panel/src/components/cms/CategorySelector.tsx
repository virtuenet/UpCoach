    ...
    setCategories([
      {
        ...
        slug: 'productivity',
        children: [
          { id: '11', name: 'Time Management', slug: 'time-management', parentId: '1' },
          { id: '12', name: 'Focus & Concentration', slug: 'focus-concentration', parentId: '1' }
        ]
      },
      {
        id: '2',
        ...
        slug: 'wellness',
        children: [
          { id: '21', name: 'Mental Health', slug: 'mental-health', parentId: '2' },
          { id: '22', name: 'Physical Health', slug: 'physical-health', parentId: '2' }
        ]
      },
